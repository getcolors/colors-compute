...
external-key, and node configurations. The original 2026-09-09 schema checks
...
Latest compute validation passed Blue 510 tests, Green 107 tests with 1,327
assertions, Red 314 tests plus typecheck, and 476 parity cases in each color.
