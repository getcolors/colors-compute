...
This is a rendering API, not the eventual common create/delete operation.
The runtime adapter must translate desired-state settings into provider inputs,
validate semantics, and manage state/SSH ownership before invoking OpenTofu.
